...
//   private loggedInUserInfo = new BehaviorSubject<loggedInUser>(<loggedInUser>{});
//   private autoLogoutTimer: ReturnType<typeof setTimeout> | null = null; // ✅ FIXED
...
//   createUser(user: user): Observable<any> {
//     return this.httpClient.post('http://localhost:5001/users/signup', user);
//   }

//   login(email: string, password: string): Observable<any> {
//     return this.httpClient.post('http://localhost:5001/users/login', { email, password });
//   }
...
//       clearTimeout(this.autoLogoutTimer); // ✅ Clear the timer
...
//   private setAutoLogoutTimer(duration: number): void {
//     if (this.autoLogoutTimer) {
//       clearTimeout(this.autoLogoutTimer); // ✅ Prevent duplicates
//     }
//     this.autoLogoutTimer = setTimeout(() => {
//       this.logout();
//     }, duration);
